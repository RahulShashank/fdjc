        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            while($row = mysqli_fetch_array($result)) {
                ...
                if(isset($flightLegsCondition)) {
                    ...
                    echo    "<span data-toggle=\"modal\" data-target=\"#seatModal\" data-seat=\"$seat\">
                                <a role=\"button\" id=\"$seat\" class=\"btn $buttonType btn-xs seat\" style=\"width:30px\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Seat $seat - $countTooltip\" data-poload=\"/test.php\">$count</a>
                            </span>";
                }
                echo "</td>";
                $j++;
